---
# Composer: H.Purcell (details inherited from parent)
id: editions-purcell-h-what-power-art-thou
parent: ../README.md
...
comments: >
  Score derived from Jean-Charles Malahieude's edition (CC BY 3.0), 
  based on the Musical Antiquarian Society edition of Edward Taylor.
files:
